...
if __name__ == '__main__':
    new_df = df.loc[:2100,:].dropna(axis=1).rolling(window=100, center=True, min_periods=0, win_type='parzen').mean()
    safe, magnitude = outliergram(new_df, mode='magnitude', report=True, factorsh=1.5, factormg=2.5)
