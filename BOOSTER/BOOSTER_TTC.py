...
def writebook(chlist):
    ...
    testframedict = {}
    directory = os.fspath('P:/BOOSTER/DATA/')
...
#        os.remove('C:/Users/giguerf/.spyder-py3/SAI/'+filename)
    ...
    for chname in chlist:
        framelist = testframedict[filename[:-9]][['T_10000_0']] # for some reason [[]] returns dataframe instead of series!
    ...
    data1.to_excel('C:/Users/giguerf/.spyder-py3/SAI/1XCHST0000Y7ACXC.xlsx', index = False)
    data2.to_excel('C:/Users/giguerf/.spyder-py3/SAI/1XPELV0000Y7ACXA.xlsx', index = False)
