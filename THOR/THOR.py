...
#chlist.extend(codestring('11NECK????TH????'))
#chlist.extend(codestring('11ILAC????TH????'))
#chlist.extend([ '11HEAD0000THAVXA', '11HEAD0000THAVYA', '11HEAD0000THAVZA', '11HEAD0000THANYA'])
chlist.extend(['11SPIN0100THACYC', '11CHST0000THACYC','11THSP0100THAVXA', '11THSP0100THAVZA'])
...
tcns  = table.CIBLE.tolist()#table[table.CBL_BELT.isin(['SLIP','OK'])].CIBLE.tolist()
#new slip/ok top 8
